...
describe('Searchable Repository unit tests', () => {
  describe('SearchParams tests', () => {
    it('page prop', () => {
      ...
      expect(searchParams.page).toEqual(1);
    ...
    it('perPage prop', () => {
      const searchParams = new SearchParams();
      expect(searchParams.perPage).toEqual(15);
    ...
    it('sortDir prop', () => {
      ...
      expect(searchParam.sortDir).toBeNull();

      searchParam = new SearchParams({ sort: null });
      expect(searchParam.sortDir).toBeNull();

      searchParam = new SearchParams({ sort: undefined });
      expect(searchParam.sortDir).toBeNull();

      searchParam = new SearchParams({ sort: '' });
      expect(searchParam.sortDir).toBeNull();
  ...
  describe('SearchResult tests', () => {
    it('constructor props', () => {
      ...
      expect(searchResult.lastPage).toBe(6);
    });
  });
});
